...
import pytest
from src.abm_research.core.unified_lead_scorer import (
    MEDDICContactScorer,
    MEDDICContactScore,
...
class TestScoreBreakdown:
    ...
    def test_scores_are_within_valid_range(self):
        ...
        for title in test_titles:
            ...
            assert 0 <= result.engagement_potential_score <= 100, f"engagement_potential_score out of range for '{title}'"
...
class TestRecommendedApproach:
    ...
    def test_entry_point_gets_pain_based_approach(self):
        ...
        assert 'pain' in result.recommended_approach.lower() or 'Pain' in result.recommended_approach
