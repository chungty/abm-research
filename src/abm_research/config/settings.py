...
LINKEDIN_REQUEST_DELAY = float(
    os.getenv("LINKEDIN_REQUEST_DELAY", "2.0")
...
CONFIDENCE_THRESHOLD = int(
    os.getenv("CONFIDENCE_THRESHOLD", "30")
)  # minimum confidence for inclusion
LEAD_SCORE_THRESHOLD = int(
    os.getenv("LEAD_SCORE_THRESHOLD", "60")
)  # threshold for Phase 3 enrichment
