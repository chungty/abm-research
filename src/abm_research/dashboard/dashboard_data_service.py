...
from ..config.abm_config import config
...
class NotionDataService:
    ...
    def __init__(self):
        ...
        from ..config.abm_config import config as abm_config
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for result in data.get('results', []):
                    ...
                    account = {
                        'id': result['id'],
                        'name': self._extract_title(props.get('Company Name', {})),
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for result in data.get('results', []):
                    ...
                    # Extract company name directly from Company field
                    company_name = self._extract_rich_text(props.get('Company', {}))
