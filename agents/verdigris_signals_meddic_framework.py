...
class VerdigrisSignalsMEDDIC:
    ...
    def _build_signals_personas(self) -> Dict[str, VerdigrisSignalsPersona]:
        ...
        return {
            ...
            'facilities_manager': VerdigrisSignalsPersona(
                ...
                title_patterns=[
                    "Data Center Facilities Manager", "Critical Facilities Engineer",
                    "Facilities Manager", "Data Center Manager", "Critical Infrastructure Manager"
                ],
                responsibilities=[
            ...
            'operations_director': VerdigrisSignalsPersona(
                ...
                title_patterns=[
                    "Director of Data Center Operations", "VP Infrastructure", "VP IT Infrastructure",
                    "Operations Director", "Director Infrastructure", "VP Operations"
                ],
                responsibilities=[
            ...
            'operations_manager': VerdigrisSignalsPersona(
                ...
                title_patterns=[
                    "Operations Manager", "Capacity Engineer", "Data Center Operations Manager",
                    "Facilities Operations Manager", "Critical Systems Manager"
                ],
                responsibilities=[
            ...
            'facilities_engineer': VerdigrisSignalsPersona(
                ...
                title_patterns=[
                    "Facilities Engineer", "Data Center Technician", "Critical Facilities Technician",
                    "Infrastructure Engineer", "Facilities Technician", "Data Center Engineer"
                ],
                responsibilities=[
            ...
            'capacity_engineer': VerdigrisSignalsPersona(
                ...
                persona_type=PersonaType.CHAMPION,
                title_patterns=[
                    "Capacity Engineer", "Energy Specialist", "Capacity Planning Engineer",
                    "Power Engineer", "Energy Manager", "Sustainability Engineer"
                ],
                responsibilities=[
            ...
            'dcim_administrator': VerdigrisSignalsPersona(
                ...
                title_patterns=[
                    "DCIM Administrator", "Systems Administrator", "IT Manager",
                    "Network Operations Manager", "Infrastructure Administrator"
                ],
                responsibilities=[
    ...
    def classify_contact(self, contact: Dict) -> Dict:
        ...
        for persona_key, persona in self.personas.items():
            ...
            domain_keywords = ['facilities', 'infrastructure', 'operations', 'critical', 'power', 'data center']
