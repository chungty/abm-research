...
def analyze_field_overlap():
    ...
    print('   🎬 Event Lifecycle: Specific event status (Rumored → Announced → In-Progress → Completed)')
    ...
    print('✅ Good separation: Physical Infrastructure (persistent) vs Event-specific scoring (temporal)')
