...
def create_schema_compliance_plan():
    ...
    schema_requirements = {
        'account_relations': {
            ...
            'affected_areas': ['Contact Discovery', 'Event Detection', 'Partnership Analysis', 'Data Persistence']
        },
        'confidence_indicators': {
            ...
            'affected_areas': ['Intelligence Gathering', 'Data Processing', 'Reporting', 'Dashboard']
        },
    ...
    code_areas = {
        ...
        'core_system': {
            'files': [
                'src/abm_research/core/abm_system.py'
            ],
            'changes_needed': [
        ...
        'persistence': {
            'files': [
                'src/abm_research/integrations/notion_client.py'
            ],
            'changes_needed': [
        ...
        'dashboard_ui': {
            'files': [
                'src/abm_research/dashboard/abm_dashboard.py'
            ],
            'changes_needed': [
    ...
    for area_name, area_details in code_areas.items():
        ...
        print(f'{priority_emoji} {area_name.upper().replace("_", " ")} ({area_details["priority"]} Priority)')
