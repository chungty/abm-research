...
def test_current_databases():
    ...
    print("🔍 Testing current database IDs...")
...
def create_new_databases():
    ...
    try:
        ...
        print("📄 Please provide a Notion page ID where databases should be created.")
        print("💡 You can get this from any Notion page URL (the 32-character ID)")
        ...
        if not parent_page_id:
            print("⚠️  No parent page provided. Cannot create databases.")
            return False
...
def main():
    """Main execution"""
    print("🔧 NOTION DATABASE CONFIGURATION FIX")
    print("=" * 50)
    ...
    if current_working:
        ...
        if choice.lower() != "y":
            print("✅ No changes needed. Databases are working.")
            return

    # Create new databases
    print("\n🔄 Current databases are not working. Let's create new ones.")
    success = create_new_databases()

    if success:
        print("\n🎉 Database setup complete!")
        print("💡 Please restart your application to use the new database IDs.")
    else:
        print("\n❌ Database setup failed.")
        print("💡 Please check your Notion integration permissions and try again.")
