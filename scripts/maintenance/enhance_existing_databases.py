...
"""
    ...
    print("\n✨ ENHANCED FEATURES:")
    print("   📊 Accounts: Complete firmographics + ICP scoring + business model classification")
    print("   👤 Contacts: Verdigris Signals MEDDIC framework + transparent lead scoring")
