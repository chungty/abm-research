            ...
            properties = {
                "Name": {
                    "title": [
                        {
                            "type": "text",
                            "text": {"content": account_data.get("name", "Unknown Company")},
                        }
                    ]
                }
            }
            ...
            if account_data.get("apollo_account_id"):
                properties["Apollo Account ID"] = {
                    "rich_text": [
                        {
                            "type": "text",
                            "text": {"content": str(account_data["apollo_account_id"])},
                        }
                    ]
                }
            ...
            if account_data.get("apollo_organization_id"):
                properties["Apollo Organization ID"] = {
                    "rich_text": [
                        {
                            "type": "text",
                            "text": {"content": str(account_data["apollo_organization_id"])},
                        }
                    ]
                }
    ...
    def create_contact_entry(self, contact_data: dict, account_id: str = None) -> str:
        ...
        try:
            ...
            properties = {
                "Name": {
                    "title": [
                        {
                            "type": "text",
                            "text": {"content": contact_data.get("name", "Unknown Contact")},
                        }
                    ]
                }
            }
            ...
            if contact_data.get("engagement_potential_score"):
                properties["Engagement Potential Score"] = {
                    "number": contact_data["engagement_potential_score"]
                }

            # Map to existing field names (from our analysis)
            if contact_data.get("buying_committee_role"):
                properties["Buying committee role"] = {
                    "select": {"name": contact_data["buying_committee_role"]}
                }
            ...
            if contact_data.get("apollo_contact_id"):
                properties["Apollo Contact ID"] = {
                    "rich_text": [
                        {
                            "type": "text",
                            "text": {"content": str(contact_data["apollo_contact_id"])},
                        }
                    ]
                }
            ...
            if contact_data.get("apollo_person_id"):
                properties["Apollo Person ID"] = {
                    "rich_text": [
                        {"type": "text", "text": {"content": str(contact_data["apollo_person_id"])}}
                    ]
                }
...
class CleanABMSystem:
    ...
    def process_genesis_cloud(self):
        ...
        print(
            f"   👤 Contacts: https://www.notion.so/{self.notion.database_ids['contacts'].replace('-', '')}"
        )
        ...
        return {
            ...
            "top_lead_score": classified_contacts[0].get("final_lead_score", 0)
